...
-- Every overlay is drawn at sixty percent of what its strength asks for, so a slider at
-- 100 is a gentler ceiling than the original mod's. See ALPHA_SCALE in the mod.
